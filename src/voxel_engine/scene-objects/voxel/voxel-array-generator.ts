...
import type { VoxelArray } from "./voxel";

// collection of functions returning VoxelArrays of common shapes

export function getEmptyVoxelArray(size: Vector3) : VoxelArray{
...
export function generatePyramidVoxelArray(size: Vector3, color: Vector4): VoxelArray{
    const outVoxels = getEmptyVoxelArray(size);
    let baseShortage = 0;
...
export function generateCylinderVoxelArray(size: Vector3, color: Vector4): VoxelArray{
    const outVoxels = getEmptyVoxelArray(size);
...
export function generateSphereVoxelArray(size: Vector3, color: Vector4): VoxelArray{
    const outVoxels = getEmptyVoxelArray(size);    
